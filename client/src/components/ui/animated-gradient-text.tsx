...
export default function AnimatedGradientText({
   ...
   return (
      <div
         className={ny(
            'group relative mx-auto flex max-w-fit flex-row items-center justify-center rounded-2xl    ease-out [--bg-size:300%] hover:shadow-[inset_0_-5px_10px_#8fdfff3f] dark:bg-black/40',
            className,
         )}
      >
